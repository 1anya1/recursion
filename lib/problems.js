...
function lucasNumber(n) {
    //base case in this propblem consists of 2 values 
    if(n===0) return 2;
    if(n===1) return 1;
...
function reverseString(str) {
    ...
    //updating the string as they are immutable with methods 
    str = str.slice(0, -1); 
    return char + reverseString(str)
